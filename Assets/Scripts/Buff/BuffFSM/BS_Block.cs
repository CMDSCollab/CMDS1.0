...
public class BS_Block : BuffBaseState
{
    public override void EnterState(GameMaster gM)
    {
        switch (gM.buffSM.buffUsage)
        {
            ...
            case BuffUsage.AddNew:
                //gM.buffSM.AddNewBuff(EnemyBuff.Block, BuffTimeType.Temporary, 1, BuffValueType.NoValue, 1);
                gM.buffM.InstantiateBuff(EnemyBuff.Block);
                gM.buffSM.buffTrans = gM.buffSM.GetBuffRectTrans(EnemyBuff.Block);
